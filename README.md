...
Pirate Radio is a simple macOS app that lets you pick an audio file (WAV, MP3, AIFF) or stream live audio input, choose a broadcast frequency between 88.00 and 108.00 MHz, and start or stop transmission. A progress bar shows how much of the file has played.
