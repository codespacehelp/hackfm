...
from gnuradio import analog, blocks, eng_notation, filter, gr, qtgui, soapy


class hackfm(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "HackFM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("HackFM")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "hackfm")
...
def main(top_block_cls=hackfm, options=None):
