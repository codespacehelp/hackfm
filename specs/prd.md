# Pirate Radio: macOS FM Transmitter App
...
├── Sources/
│   └── PirateRadio/
│       ├── PirateRadioApp.swift     # App entry point
...
├── Resources/
│   ├── Info.plist
│   └── PirateRadio.entitlements
└── BridgingHeader/
    └── HackRF-Bridging-Header.h
```
...
xcodebuild -project PirateRadio.xcodeproj \
  -scheme PirateRadio \
  -configuration Release \
  build

# Output: build/Release/PirateRadio.app
```
